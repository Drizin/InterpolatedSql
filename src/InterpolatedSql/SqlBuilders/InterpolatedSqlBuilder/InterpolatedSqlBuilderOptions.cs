...
namespace InterpolatedSql
{
    ...
    public class InterpolatedSqlBuilderOptions
    {
        ...
        /// and so does <see cref="InterpolatedSqlBuilder{U, R}.Format"/>.
        ...
        /// if your derived type will never write curly braces through <see cref="InterpolatedSqlBuilder{U, R}.AppendLiteral(string)"/>, 
        /// then you can disable this (set to false) so that it won't escape curly braces (and it will be faster).
        /// You can also use <see cref="InterpolatedSqlBuilder{U, R}.AppendRaw(string)"/>) which does not escape anything.
        /// </summary>
        ...
        /// If this is true (default is true) then this formatting will also be preserved in the underlying <see cref="InterpolatedSqlBuilder{U, R}.Format"/>
        /// (else, <see cref="InterpolatedSqlBuilder{U, R}.Format"/> will only have the numeric placeholder like {0} but without the extracted formatting).
        /// </summary>
