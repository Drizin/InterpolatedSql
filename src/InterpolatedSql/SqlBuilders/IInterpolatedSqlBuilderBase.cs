...
namespace InterpolatedSql.SqlBuilders
{
    ...
    public interface IInterpolatedSqlBuilderBase
    {
        ...
        InterpolatedSqlBuilderOptions Options { get; set; }
        ...
        /// <inheritdoc cref="InterpolatedSqlBuilderBase.AsSql"/>
        IInterpolatedSql AsSql();
