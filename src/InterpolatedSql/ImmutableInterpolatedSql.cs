...
namespace InterpolatedSql
{
    ...
    /// If you want a mutable class (to dynamically append statements) you probably need some <see cref="SqlBuilders.ISqlBuilder"/> (like <see cref="SqlBuilders.SqlBuilder"/>)
    /// </summary>
